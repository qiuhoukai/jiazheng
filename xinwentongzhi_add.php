...
if ($addnew=="1" )
{
	...
	mysql_query($sql);
	echo "<script>javascript:alert('添加成功!');location.href='xinwentongzhi_list.php?lb=$lb';</script>";
}
?>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    
	...
	<!--<tr><td>类别：</td><td><input name='leibie' type='text' id='leibie' value='<?php echo $lb;?>' />&nbsp;*</td></tr>-->
	<tr><td>类别：</td><td><select name='leibie' id='leibie'><option value="">请选择类别</option><option value="站内新闻">站内新闻</option><option value="行业资讯">行业资讯</option></select>&nbsp;*</td></tr>
	<tr><td>内容：</td><td><textarea name="neirong" style="width:700px;height:200px;visibility:hidden;"></textarea></td></tr><tr>
	  <td>附件：</td>
