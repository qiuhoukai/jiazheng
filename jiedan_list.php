...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from jiedan where 1=1";
	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ...
  <tr>
    ...
    <td width="120" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=jiedan" onclick="return confirm('真的要删除？')">删除</a> <a href="jiedan_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a> <a href="jiedan_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a> </td>
  </tr>
  	<?php
	}
}
...
<p>以上数据共<?php echo $rowscount;?>条, 
  <input type="button" name="Submit2" onclick="javascript:window.print();" value="打印本页" style='border:solid 1px #000000; color:#666666' /> <input type="button" name="Submit3" onclick="javascript:location.href='jiedan_listxls.php';" value="导出EXCEL" style='border:solid 1px #000000; color:#666666' />
</p>
<p align="center"><a href="jiedan_list.php?pagecurrent=1">首页</a>, <a href="jiedan_list.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="jiedan_list.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="jiedan_list.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
