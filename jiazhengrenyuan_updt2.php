...
if ($addnew=="1" )
{
	...
	$sql="update jiazhengrenyuan set jiazhengbianhao='$jiazhengbianhao',mima='$mima',jiazhengxingming='$jiazhengxingming',jiazhengxingbie='$jiazhengxingbie',fuwuleixing='$fuwuleixing',chushengriqi='$chushengriqi',jiazhengshouji='$jiazhengshouji',zhaopian='$zhaopian',jiazhengjianjie='$jiazhengjianjie' where jiazhengbianhao= '".$_SESSION["username"]."'";
	mysql_query($sql);
...
<?php
$sql="select * from jiazhengrenyuan where jiazhengbianhao='".$_SESSION["username"]."'";
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      <tr><td>家政编号：</td><td><input name='jiazhengbianhao' type='text' id='jiazhengbianhao' value='<?php echo mysql_result($query,0,jiazhengbianhao);?>' readonly='readonly' /> 此项主键，不得修改</td></tr>
