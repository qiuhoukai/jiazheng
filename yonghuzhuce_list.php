...
?></td>
	...
	<td align="center"><img src="<?php echo mysql_result($query,$i,zhaopian);?>" width="73" height="77" /></td>
...
?></td>
    <td width="70" align="center"><a href="del_guanliyuan.php?id=<?php
		echo mysql_result($query,$i,"id");
	?>&tablename=yonghuzhuce" onclick="return confirm('确认删除？')">删除</a> <a href="yonghuzhuce_updt.php?id=<?php
		echo mysql_result($query,$i,"id");
	?>">修改</a></td>
  </tr>
  	<?php
