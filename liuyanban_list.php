...
?></td>
	...
	<td><img src="<?php echo mysql_result($query,$i,zhaopian);?>" width="75" height="82" /></td>
...
?></td>
	...
	<a href="liuyanban_huifu.php?id=<?php echo mysql_result($query,$i,id);?>">回复</a>
	<a href="del_liuyanban.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=liuyanban" onclick="return confirm('真的要删除？')">删除</a> 
	<!--<a href="del_liuyanban.php?id=<?php echo mysql_result($query,$i,"id");?>"></a>-->
	</td>
  </tr>
  	<?php
	}
