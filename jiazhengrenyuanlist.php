...
<table width="98%" border="0"  align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse" class="newsline">  
  ...
  <?php 
    $sql="select id,jiazhengbianhao,jiazhengxingming,jiazhengxingbie,fuwuleixing,chushengriqi,zhaopian from jiazhengrenyuan where issh='是'";
...
<div class="fy"><a href="jiazhengrenyuanlist.php?pagecurrent=1">首页</a> <a href="jiazhengrenyuanlist.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> <a href="jiazhengrenyuanlist.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a> <a href="jiazhengrenyuanlist.php?pagecurrent=<?php echo $pagecount;?>">末页</a> 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </div>
